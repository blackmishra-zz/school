<nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.html"><b><img src="<?php echo base_url();?>plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs"><strong>elite</strong>School</span></a></div>
          ...
          <div class="notify"><span class="heartbit"></span><span class="point"></span></div>
                    ...
                    <!-- /.dropdown -->
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="<?php echo base_url();?>plugins/images/users/d1.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php echo $this->session->userdata('sess_name');?></b> </a>
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            <li><a href="<?php echo base_url();?>faculty/import_data"><i class="ti-user"></i>  Marks upload</a></li>
                            <li><a href="<?php echo base_url();?>faculty/view_std"><i class="ti-email"></i>  View Students</a></li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        <a href="#" class="waves-effect"><img src="<?php echo base_url();?>plugins/images/users/d1.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"><?php echo $this->session->userdata('sess_name');?><span class="fa arrow"></span></span>
                        </a>
                    ...
                    <li> <a href="<?php echo base_url();?>home/pst_login" class="waves-effect"><i class="ti-dashboard p-r-10"></i> <span class="hide-menu">Dashboard</span></a> </li>
            ...
            <span class="fa arrow"></span></a>
                    ...
                    <li><a href="<?php echo base_url();?>home/logout" class="waves-effect"><i class="icon-logout fa-fw"></i> <span class="hide-menu">Log out</span></a></li>
